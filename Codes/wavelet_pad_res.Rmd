...
```{r location to save}
dir_pwr = "G:/My Drive/Research/Projects/DC_auto/Data/Nov2024_rerun/result_pad_64d_res/df_temporal_pwr/"
dir_diurnal = "G:/My Drive/Research/Projects/DC_auto/Data/Nov2024_rerun/result_pad_64d_res/df_diurnal/"
...
# csv output
write.csv(rRh_PAR_May22_pwr$df, paste0(dir_pwr, "rRh_PAR_May22.csv"), row.names = F)
write.csv(rRh_Ts_May22_pwr$df, paste0(dir_pwr, "rRh_Ts_May22.csv"), row.names = F)
write.csv(rRh_SWC_May22_pwr$df, paste0(dir_pwr, "rRh_SWC_May22.csv"), row.names = F)
...
save_to_csv(wc_rRh_May22_diurnal_summary, dir_diurnal, "wc_rRh_May22_")
...
# csv output
write.csv(rRa_PAR_May22_pwr$df, paste0(dir_pwr, "rRa_PAR_May22.csv"), row.names = F)
write.csv(rRa_Ts_May22_pwr$df, paste0(dir_pwr, "rRa_Ts_May22.csv"), row.names = F)
write.csv(rRa_SWC_May22_pwr$df, paste0(dir_pwr, "rRa_SWC_May22.csv"), row.names = F)

# extracting diurnal angle & power patterns from heatmap
wc_rRa_May22_diurnal_summary <- wc_result_summary(SR_Rh_May22_res, "rRa", wc_rRa_May22)
save_to_csv(wc_rRa_May22_diurnal_summary, dir_diurnal, "wc_rRa_May22_")
...
write.csv(rRh_May22_pwr$df, paste0(dir_pwr, "rRh_May22.csv"), row.names = F)
...
write.csv(rRa_May22_pwr$df, paste0(dir_pwr, "rRa_May22.csv"), row.names = F)
```
...
# csv output
write.csv(rRh_PAR_Mar23_pwr$df, paste0(dir_pwr, "rRh_PAR_Mar23.csv"), row.names = F)
write.csv(rRh_Ts_Mar23_pwr$df, paste0(dir_pwr, "rRh_Ts_Mar23.csv"), row.names = F)
write.csv(rRh_SWC_Mar23_pwr$df, paste0(dir_pwr, "rRh_SWC_Mar23.csv"), row.names = F)

# result
wc_rRh_Mar23_diurnal_summary <- wc_result_summary(SR_Rh_Mar23_res, "rRh", wc_rRh_Mar23)
save_to_csv(wc_rRh_Mar23_diurnal_summary, dir_diurnal, "wc_rRh_Mar23_")
...
# csv output
write.csv(rRa_PAR_Mar23_pwr$df, paste0(dir_pwr, "rRa_PAR_Mar23.csv"), row.names = F)
write.csv(rRa_Ts_Mar23_pwr$df, paste0(dir_pwr, "rRa_Ts_Mar23.csv"), row.names = F)
write.csv(rRa_SWC_Mar23_pwr$df, paste0(dir_pwr, "rRa_SWC_Mar23.csv"), row.names = F)

# summary
wc_rRa_Mar23_diurnal_summary <- wc_result_summary(SR_Rh_Mar23_res, "Ra", wc_rRa_Mar23)
save_to_csv(wc_rRa_Mar23_diurnal_summary, dir_diurnal, "wc_rRa_Mar23_")
...
write.csv(rRh_Mar23_pwr$df, paste0(dir_pwr, "rRh_Mar23.csv"), row.names = F)
...
write.csv(rRa_Mar23_pwr$df, paste0(dir_pwr, "rRa_Mar23.csv"), row.names = F)
```
...
# csv output
write.csv(rRh_PAR_Jan24_pwr$df, paste0(dir_pwr, "rRh_PAR_Jan24.csv"), row.names = F)
write.csv(rRh_Ts_Jan24_pwr$df, paste0(dir_pwr, "rRh_Ts_Jan24.csv"), row.names = F)
write.csv(rRh_SWC_Jan24_pwr$df, paste0(dir_pwr, "rRh_SWC_Jan24.csv"), row.names = F)

wc_rRh_Jan24_diurnal_summary <- wc_result_summary(SR_Rh_Jan24_res, "rRh", wc_rRh_Jan24)
save_to_csv(wc_rRh_Jan24_diurnal_summary, dir_diurnal, "wc_rRh_Jan24_")
...
# csv output
write.csv(rRa_PAR_Jan24_pwr$df, paste0(dir_pwr, "rRa_PAR_Jan24.csv"), row.names = F)
write.csv(rRa_Ts_Jan24_pwr$df, paste0(dir_pwr, "rRa_Ts_Jan24.csv"), row.names = F)
write.csv(rRa_SWC_Jan24_pwr$df, paste0(dir_pwr, "rRa_SWC_Jan24.csv"), row.names = F)

# result
wc_rRa_Jan24_diurnal_summary <- wc_result_summary(SR_Rh_Jan24_res, "rRa", wc_rRa_Jan24)
save_to_csv(wc_rRa_Jan24_diurnal_summary, dir_diurnal, "wc_rRa_Jan24_")
...
# csv output
write.csv(rRh_PAR_Feb24_pwr$df, paste0(dir_pwr, "rRh_PAR_Feb24.csv"), row.names = F)
write.csv(rRh_Ts_Feb24_pwr$df, paste0(dir_pwr, "rRh_Ts_Feb24.csv"), row.names = F)
write.csv(rRh_SWC_Feb24_pwr$df, paste0(dir_pwr, "rRh_SWC_Feb24.csv"), row.names = F)

wc_rRh_Feb24_diurnal_summary <- wc_result_summary(SR_Rh_Feb24_res, "rRh", wc_rRh_Feb24)
save_to_csv(wc_rRh_Feb24_diurnal_summary, dir_diurnal, "wc_rRh_Feb24_")
...
# csv output
write.csv(rRa_PAR_Feb24_pwr$df, paste0(dir_pwr, "rRa_PAR_Feb24.csv"), row.names = F)
write.csv(rRa_Ts_Feb24_pwr$df, paste0(dir_pwr, "rRa_Ts_Feb24.csv"), row.names = F)
write.csv(rRa_SWC_Feb24_pwr$df, paste0(dir_pwr, "rRa_SWC_Feb24.csv"), row.names = F)

wc_rRa_Feb24_diurnal_summary <- wc_result_summary(SR_Rh_Feb24_res, "rRh", wc_rRa_Feb24)
save_to_csv(wc_rRa_Feb24_diurnal_summary, dir_diurnal, "wc_rRa_Feb24_")
...
# csv output
write.csv(rRh_PAR_Mar24_pwr$df, paste0(dir_pwr, "rRh_PAR_Mar24.csv"), row.names = F)
write.csv(rRh_Ts_Mar24_pwr$df, paste0(dir_pwr, "rRh_Ts_Mar24.csv"), row.names = F)
write.csv(rRh_SWC_Mar24_pwr$df, paste0(dir_pwr, "rRh_SWC_Mar24.csv"), row.names = F)

wc_rRh_Mar24_diurnal_summary <- wc_result_summary(SR_Rh_Mar24_res, "rRh", wc_rRh_Mar24)
save_to_csv(wc_rRh_Mar24_diurnal_summary, dir_diurnal, "wc_rRh_Mar24_")
...
# csv output
write.csv(rRa_PAR_Mar24_pwr$df, paste0(dir_pwr, "rRa_PAR_Mar24.csv"), row.names = F)
write.csv(rRa_Ts_Mar24_pwr$df, paste0(dir_pwr, "rRa_Ts_Mar24.csv"), row.names = F)
write.csv(rRa_SWC_Mar24_pwr$df, paste0(dir_pwr, "rRa_SWC_Mar24.csv"), row.names = F)

wc_rRa_Mar24_diurnal_summary <- wc_result_summary(SR_Rh_Mar24_res, "rRh", wc_rRa_Mar24)
save_to_csv(wc_rRa_Mar24_diurnal_summary, dir_diurnal, "wc_rRa_Mar24_")
...
write.csv(rRh_Jan24_pwr$df, paste0(dir_pwr, "rRh_Jan24.csv"), row.names = F)
...
write.csv(rRa_Jan24_pwr$df, paste0(dir_pwr, "rRa_Jan24.csv"), row.names = F)
...
write.csv(rRh_Feb24_pwr$df, paste0(dir_pwr, "rRh_Feb24.csv"), row.names = F)
...
write.csv(rRa_Feb24_pwr$df, paste0(dir_pwr, "rRa_Feb24.csv"), row.names = F)
...
write.csv(rRh_Mar24_pwr$df, paste0(dir_pwr, "rRh_Mar24.csv"), row.names = F)
...
write.csv(rRa_Mar24_pwr$df, paste0(dir_pwr, "rRa_Mar24.csv"), row.names = F)
