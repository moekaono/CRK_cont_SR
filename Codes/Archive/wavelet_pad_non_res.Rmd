...
# Rh
wc_Rh_May22 <- wc_summary(SR_Rh_May22, "Rh")

# heatmap
wc_img_gen(wc_Rh_May22, "Rh")

# temporal power data & graph
Rh_PAR_May22_pwr <- wc_avg(wc_Rh_May22$PAR, 25)
Rh_Ts_May22_pwr <- wc_avg(wc_Rh_May22$Ts, 25)
Rh_SWC_May22_pwr <- wc_avg(wc_Rh_May22$SWC, 25)

# csv output
write.csv(Rh_PAR_May22_pwr$df, paste0(dir_pwr, "Rh_PAR_May22.csv"), row.names = F)
write.csv(Rh_Ts_May22_pwr$df, paste0(dir_pwr, "Rh_Ts_May22.csv"), row.names = F)
write.csv(Rh_SWC_May22_pwr$df, paste0(dir_pwr, "Rh_SWC_May22.csv"), row.names = F)

# extracting diurnal angle & power patterns from heatmap
wc_Rh_May22_diurnal_summary <- wc_result_summary(SR_Rh_May22, "Rh", wc_Rh_May22)
# save as csv
save_to_csv(wc_Rh_May22_diurnal_summary, dir_diurnal, "wc_Rh_May22_")


# viz
ggarrange(
  wc_lag_img(wc_Rh_May22_diurnal_summary$PAR, "PAR"),
  wc_lag_img(wc_Rh_May22_diurnal_summary$Ts, "Ts"),
  wc_lag_img(wc_Rh_May22_diurnal_summary$SWC, "SWC"),
  ncol = 3, common.legend = T
)


#  Ra
wc_Ra_May22 <- wc_summary(SR_Rh_May22, "Ra1")
wc_img_gen(wc_Ra_May22, "Ra")

# power avg
Ra_PAR_May22_pwr <- wc_avg(wc_Ra_May22$PAR, 25)
Ra_Ts_May22_pwr <- wc_avg(wc_Ra_May22$Ts, 25)
Ra_SWC_May22_pwr <- wc_avg(wc_Ra_May22$SWC, 25)

# csv output
write.csv(Ra_PAR_May22_pwr$df, paste0(dir_pwr, "Ra_PAR_May22.csv"), row.names = F)
write.csv(Ra_Ts_May22_pwr$df, paste0(dir_pwr, "Ra_Ts_May22.csv"), row.names = F)
write.csv(Ra_SWC_May22_pwr$df, paste0(dir_pwr, "Ra_SWC_May22.csv"), row.names = F)

wc_Ra_May22_diurnal_summary <- wc_result_summary(SR_Rh_May22, "Ra1", wc_Ra_May22)

save_to_csv(wc_Ra_May22_diurnal_summary, dir_diurnal, "wc_Ra_May22_")

# viz
ggarrange(
  wc_lag_img(wc_Ra_May22_diurnal_summary$PAR, "PAR"),
  wc_lag_img(wc_Ra_May22_diurnal_summary$Ts, "Ts"),
  wc_lag_img(wc_Ra_May22_diurnal_summary$SWC, "SWC"),
  ncol = 3, common.legend = T
)
...
```{r WT 2022}
wt_Rh_May22 <- 
  analyze.wavelet(wc_Rh_May22$PAR$series,"Rh", 
                  loess.span = 0,     ## no detrending required
                  dt = 1/24,          ## defines the time unit --- there are 24 slots in a day! Time unit = 1 day
                  dj = 1/100,         ## resolution along period axis
                  lowerPeriod = 1/4,  ## 6 hour
...
Rh_May22_pwr <- wt_avg(wt_Rh_May22, 25)
write.csv(Rh_May22_pwr$df, paste0(dir_pwr, "Rh_May22.csv"), row.names = F)

wt.image(wt_Rh_May22,  
         legend.params = 
             list(
...
# rRa
wt_Ra_May22 <- 
  analyze.wavelet(wc_Ra_May22$PAR$series,"Ra1", 
                  loess.span = 0,     ## no detrending required
                  dt = 1/24,          ## defines the time unit --- there are 24 slots in a day! Time unit = 1 day
                  dj = 1/100,         ## resolution along period axis
                  lowerPeriod = 1/4,  ## 6 hour
...
Ra_May22_pwr <- wt_avg(wt_Ra_May22, 25)
write.csv(Ra_May22_pwr$df, paste0(dir_pwr, "Ra_May22.csv"), row.names = F)

wt.image(wt_Ra_May22,  
         legend.params = 
             list(
                 lab = "wavelet power levels", # axis label
                 lab.line = 1.5, # distance between bar label and axis label
...
```{r CWT Wnt23}
apply(SR_Rh_Wnt23, 2, pMiss)

# gap length 
detect_gaps(SR_Rh_Wnt23, "TS_1_1_1")
detect_gaps(SR_Rh_Wnt23, "SWC_1_1_1")
detect_gaps(SR_Rh_Wnt23, "SR1")
detect_gaps(SR_Rh_Wnt23, "Rh")
detect_gaps(SR_Rh_Wnt23, "Ra1")



# Rh
wc_Rh_Mar23 <- wc_summary(SR_Rh_Mar23, "Rh")
wc_img_gen(wc_Rh_Mar23, "Rh")

# power avg
Rh_PAR_Mar23_pwr <- wc_avg(wc_Rh_Mar23$PAR, 25)
Rh_Ts_Mar23_pwr <- wc_avg(wc_Rh_Mar23$Ts, 25)
Rh_SWC_Mar23_pwr <- wc_avg(wc_Rh_Mar23$SWC, 25)

# csv output
write.csv(Rh_PAR_Mar23_pwr$df, paste0(dir_pwr, "Rh_PAR_Mar23.csv"), row.names = F)
write.csv(Rh_Ts_Mar23_pwr$df, paste0(dir_pwr, "Rh_Ts_Mar23.csv"), row.names = F)
write.csv(Rh_SWC_Mar23_pwr$df, paste0(dir_pwr, "Rh_SWC_Mar23.csv"), row.names = F)
                        

wc_Rh_Mar23_summary <- wc_result_summary(SR_Rh_Mar23, "Rh", wc_Rh_Mar23)

save_to_csv(wc_Rh_Mar23_summary, dir_diurnal, "wc_rRh_Mar23_")

# viz
ggarrange(
  wc_lag_img(wc_Rh_Mar23_summary$PAR, "PAR"),
  wc_lag_img(wc_Rh_Mar23_summary$Ts, "Ts"),
  wc_lag_img(wc_Rh_Mar23_summary$SWC, "SWC"),
  ncol = 3, common.legend = T
)


# residual Ra
wc_Ra_Mar23 <- wc_summary(SR_Rh_Mar23, "Ra1")
wc_img_gen(wc_Ra_Mar23, "Ra")

# power avg
Ra_PAR_Mar23_pwr <- wc_avg(wc_Ra_Mar23$PAR, 25)
Ra_Ts_Mar23_pwr <- wc_avg(wc_Ra_Mar23$Ts, 25)
Ra_SWC_Mar23_pwr <- wc_avg(wc_Ra_Mar23$SWC, 25)

# csv output
write.csv(Ra_PAR_Mar23_pwr$df, paste0(dir_pwr, "Ra_PAR_Mar23.csv"), row.names = F)
write.csv(Ra_Ts_Mar23_pwr$df, paste0(dir_pwr, "Ra_Ts_Mar23.csv"), row.names = F)
write.csv(Ra_SWC_Mar23_pwr$df, paste0(dir_pwr, "Ra_SWC_Mar23.csv"), row.names = F)


wc_Ra_Mar23_summary <- wc_result_summary(SR_Rh_Mar23, "Ra1", wc_Ra_Mar23)

save_to_csv(wc_Ra_Mar23_summary, dir_diurnal, "wc_Ra_Mar23_")

# viz
ggarrange(
  wc_lag_img(wc_Ra_Mar23_summary$PAR, "PAR"),
  wc_lag_img(wc_Ra_Mar23_summary$Ts, "Ts"),
  wc_lag_img(wc_Ra_Mar23_summary$SWC, "SWC"),
  ncol = 3, common.legend = T)  
...
```{r WT Wnt23}
wt_Rh_Mar23 <- 
  analyze.wavelet(wc_Rh_Mar23$PAR$series,"Rh", 
                  loess.span = 0,     ## no detrending required
                  dt = 1/24,          ## defines the time unit --- there are 24 slots in a day! Time unit = 1 day
                  dj = 1/100,         ## resolution along period axis
                  lowerPeriod = 1/4,  ## 6 hour
...
Rh_Mar23_pwr <- wt_avg(wt_Rh_Mar23, 25)
write.csv(Rh_Mar23_pwr$df, paste0(dir_pwr, "Rh_Mar23.csv"), row.names = F)

wt.image(wt_Rh_Mar23,  
         legend.params = 
             list(
                 lab = "wavelet power levels", # axis label
                 lab.line = 1.5, # distance between bar label and axis label
...
# rRa
wt_Ra_Mar23 <- 
  analyze.wavelet(wc_Ra_Mar23$PAR$series,"Ra1", 
                  loess.span = 0,     ## no detrending required
                  dt = 1/24,          ## defines the time unit --- there are 24 slots in a day! Time unit = 1 day
                  dj = 1/100,         ## resolution along period axis
                  lowerPeriod = 1/4,  ## 6 hour
...
Ra_Mar23_pwr <- wt_avg(wt_Ra_Mar23, 25)
write.csv(Ra_Mar23_pwr$df, paste0(dir_pwr, "Ra_Mar23.csv"), row.names = F)

wt.image(wt_Ra_Mar23,  
         legend.params = 
             list(
                 lab = "wavelet power levels", # axis label
                 lab.line = 1.5, # distance between bar label and axis label
...
# Rh 
wc_Rh_Jan24 <- wc_summary(SR_Rh_Jan24, "Rh")

wc_img_gen(wc_Rh_Jan24, "Rh")

# power avg
Rh_PAR_Jan24_pwr <- wc_avg(wc_Rh_Jan24$PAR, 25)
Rh_Ts_Jan24_pwr <- wc_avg(wc_Rh_Jan24$Ts, 25)
Rh_SWC_Jan24_pwr <- wc_avg(wc_Rh_Jan24$SWC, 25)

# csv output
write.csv(Rh_PAR_Jan24_pwr$df, paste0(dir_pwr, "Rh_PAR_Jan24.csv"), row.names = F)
write.csv(Rh_Ts_Jan24_pwr$df, paste0(dir_pwr, "Rh_Ts_Jan24.csv"), row.names = F)
write.csv(Rh_SWC_Jan24_pwr$df, paste0(dir_pwr, "Rh_SWC_Jan24.csv"), row.names = F)
                        

wc_Rh_Jan24_summary <- wc_result_summary(SR_Rh_Jan24, "Rh", wc_Rh_Jan24)

save_to_csv(wc_Rh_Jan24_summary, dir_diurnal, "wc_Rh_Jan24_")


# viz
ggarrange(
  wc_lag_img(wc_Rh_Jan24_summary$PAR, "PAR"),
  wc_lag_img(wc_Rh_Jan24_summary$Ts, "Ts"),
  wc_lag_img(wc_Rh_Jan24_summary$SWC, "SWC"),
  ncol = 3, common.legend = T
)
...
# Ra 
wc_Ra_Jan24 <- wc_summary(SR_Rh_Jan24, "Ra1")
wc_img_gen(wc_Ra_Jan24, "Ra")

# power avg
Ra_PAR_Jan24_pwr <- wc_avg(wc_Ra_Jan24$PAR, 25)
Ra_Ts_Jan24_pwr <- wc_avg(wc_Ra_Jan24$Ts, 25)
Ra_SWC_Jan24_pwr <- wc_avg(wc_Ra_Jan24$SWC, 25)

# csv output
write.csv(Ra_PAR_Jan24_pwr$df, paste0(dir_pwr, "Ra_PAR_Jan24.csv"), row.names = F)
write.csv(Ra_Ts_Jan24_pwr$df, paste0(dir_pwr, "Ra_Ts_Jan24.csv"), row.names = F)
write.csv(Ra_SWC_Jan24_pwr$df, paste0(dir_pwr, "Ra_SWC_Jan24.csv"), row.names = F)
...
wc_Ra_Jan24_summary <- wc_result_summary(SR_Rh_Jan24, "Ra1", wc_Ra_Jan24)

save_to_csv(wc_Ra_Jan24_summary, dir_diurnal, "wc_Ra_Jan24_")


# viz
ggarrange(
  wc_lag_img(wc_Ra_Jan24_summary$PAR, "PAR"),
  wc_lag_img(wc_Ra_Jan24_summary$Ts, "Ts"),
  wc_lag_img(wc_Ra_Jan24_summary$SWC, "SWC"),
  ncol = 3, common.legend = T
)
...
# Rh residual
wc_Rh_Feb24 <- wc_summary(SR_Rh_Feb24, "Rh")
wc_img_gen(wc_Rh_Feb24, "Rh")

# power avg
Rh_PAR_Feb24_pwr <- wc_avg(wc_Rh_Feb24$PAR, 25)
Rh_Ts_Feb24_pwr <- wc_avg(wc_Rh_Feb24$Ts, 25)
Rh_SWC_Feb24_pwr <- wc_avg(wc_Rh_Feb24$SWC, 25)

# csv output
write.csv(Rh_PAR_Feb24_pwr$df, paste0(dir_pwr, "Rh_PAR_Feb24.csv"), row.names = F)
write.csv(Rh_Ts_Feb24_pwr$df, paste0(dir_pwr, "Rh_Ts_Feb24.csv"), row.names = F)
write.csv(Rh_SWC_Feb24_pwr$df, paste0(dir_pwr, "Rh_SWC_Feb24.csv"), row.names = F)

wc_Rh_Feb24_summary <- wc_result_summary(SR_Rh_Feb24, "Rh", wc_Rh_Feb24)

save_to_csv(wc_Rh_Feb24_summary, dir_diurnal, "wc_Rh_Feb24_")


# viz
ggarrange(
  wc_lag_img(wc_Rh_Feb24_summary$PAR, "PAR"),
  wc_lag_img(wc_Rh_Feb24_summary$Ts, "Ts"),
  wc_lag_img(wc_Rh_Feb24_summary$SWC, "SWC"),
  ncol = 3, common.legend = T
)
...
# Ra residual
wc_Ra_Feb24 <- wc_summary(SR_Rh_Feb24, "Ra")
wc_img_gen(wc_Ra_Feb24, "Ra")

# power avg
Ra_PAR_Feb24_pwr <- wc_avg(wc_Ra_Feb24$PAR, 25)
Ra_Ts_Feb24_pwr <- wc_avg(wc_Ra_Feb24$Ts, 25)
Ra_SWC_Feb24_pwr <- wc_avg(wc_Ra_Feb24$SWC, 25)

# csv output
write.csv(Ra_PAR_Feb24_pwr$df, paste0(dir_pwr, "Ra_PAR_Feb24.csv"), row.names = F)
write.csv(Ra_Ts_Feb24_pwr$df, paste0(dir_pwr, "Ra_Ts_Feb24.csv"), row.names = F)
write.csv(Ra_SWC_Feb24_pwr$df, paste0(dir_pwr, "Ra_SWC_Feb24.csv"), row.names = F)

wc_Ra_Feb24_summary <- wc_result_summary(SR_Rh_Feb24, "Ra", wc_Ra_Feb24)

save_to_csv(wc_Ra_Feb24_summary, dir_diurnal, "wc_Ra_Feb24_")


# viz
ggarrange(
  wc_lag_img(wc_Ra_Feb24_summary$PAR, "PAR"),
  wc_lag_img(wc_Ra_Feb24_summary$Ts, "Ts"),
  wc_lag_img(wc_Ra_Feb24_summary$SWC, "SWC"),
  ncol = 3, common.legend = T
)
...
write.csv(Rh_SWC_Mar24_pwr$df, paste0(dir_pwr, "Rh_SWC_Mar24.csv"), row.names = F)

wc_Rh_Mar24_summary <- wc_result_summary(SR_Rh_Mar24, "Rh", wc_Rh_Mar24)

save_to_csv(wc_Rh_Mar24_summary, dir_diurnal, "wc_Rh_Mar24_")

# viz
ggarrange(
  wc_lag_img(wc_Rh_Mar24_summary$PAR, "PAR"),
  wc_lag_img(wc_Rh_Mar24_summary$Ts, "Ts"),
  wc_lag_img(wc_Rh_Mar24_summary$SWC, "SWC"),
  ncol = 3, common.legend = T)



# Ra
wc_Ra_Mar24 <- wc_summary(SR_Rh_Mar24, "Ra")
wc_img_gen(wc_Ra_Mar24, "Ra")

# power avg
Ra_PAR_Mar24_pwr <- wc_avg(wc_Ra_Mar24$PAR, 25)
Ra_Ts_Mar24_pwr <- wc_avg(wc_Ra_Mar24$Ts, 25)
Ra_SWC_Mar24_pwr <- wc_avg(wc_Ra_Mar24$SWC, 25)
...
write.csv(Ra_SWC_Mar24_pwr$df, paste0(dir_pwr, "Ra_SWC_Mar24.csv"), row.names = F)


wc_Ra_Mar24_summary <- wc_result_summary(SR_Rh_Mar24, "Ra", wc_Ra_Mar24)

save_to_csv(wc_Ra_Mar24_summary, dir_diurnal, "wc_Ra_Mar24_")

# viz
ggarrange(
  wc_lag_img(wc_Ra_Mar24_summary$PAR, "PAR"),
  wc_lag_img(wc_Ra_Mar24_summary$Ts, "Ts"),
  wc_lag_img(wc_Ra_Mar24_summary$SWC, "SWC"),
  ncol = 3, common.legend = T)
...
wt_Rh_Jan24 <- 
  analyze.wavelet(wc_Rh_Jan24$PAR$series,"Rh", 
                  loess.span = 0,     ## no detrending required
                  dt = 1/24,          ## defines the time unit --- there are 24 slots in a day! Time unit = 1 day
                  dj = 1/100,         ## resolution along period axis
                  lowerPeriod = 1/4,  ## 6 hour
...
Rh_Jan24_pwr <- wt_avg(wt_Rh_Jan24, 25)
write.csv(Rh_Jan24_pwr$df, paste0(dir_pwr, "Rh_Jan24.csv"), row.names = F)

wt.image(wt_Rh_Jan24,  
         legend.params = 
             list(
                 lab = "wavelet power levels", # axis label
                 lab.line = 1.5, # distance between bar label and axis label
...
# Ra
wt_Ra_Jan24 <- 
  analyze.wavelet(wc_Ra_Jan24$PAR$series,"Ra1", 
                  loess.span = 0,     ## no detrending required
                  dt = 1/24,          ## defines the time unit --- there are 24 slots in a day! Time unit = 1 day
                  dj = 1/100,         ## resolution along period axis
                  lowerPeriod = 1/4,  ## 6 hour
...
Ra_Jan24_pwr <- wt_avg(wt_Ra_Jan24, 25)
write.csv(Ra_Jan24_pwr$df, paste0(dir_pwr, "Ra_Jan24.csv"), row.names = F)

wt.image(wt_Ra_Jan24,  
         legend.params = 
             list(
                 lab = "wavelet power levels", # axis label
                 lab.line = 1.5, # distance between bar label and axis label
...
wt_Rh_Feb24 <- 
  analyze.wavelet(wc_Rh_Feb24$PAR$series,"Rh", 
                  loess.span = 0,     ## no detrending required
                  dt = 1/24,          ## defines the time unit --- there are 24 slots in a day! Time unit = 1 day
                  dj = 1/100,         ## resolution along period axis
                  lowerPeriod = 1/4,  ## 6 hour
...
Rh_Feb24_pwr <- wt_avg(wt_Rh_Feb24, 25)
write.csv(Rh_Feb24_pwr$df, paste0(dir_pwr, "Rh_Feb24.csv"), row.names = F)

wt.image(wt_Rh_Feb24,  
         legend.params = 
             list(
                 lab = "wavelet power levels", # axis label
                 lab.line = 1.5, # distance between bar label and axis label
...
# Ra
wt_Ra_Feb24 <- 
  analyze.wavelet(wc_Ra_Feb24$PAR$series,"Ra", 
                  loess.span = 0,     ## no detrending required
                  dt = 1/24,          ## defines the time unit --- there are 24 slots in a day! Time unit = 1 day
                  dj = 1/100,         ## resolution along period axis
                  lowerPeriod = 1/4,  ## 6 hour
...
Ra_Feb24_pwr <- wt_avg(wt_Ra_Feb24, 25)
write.csv(Ra_Feb24_pwr$df, paste0(dir_pwr, "Ra_Feb24.csv"), row.names = F)

wt.image(wt_Ra_Feb24,  
         legend.params = 
             list(
                 lab = "wavelet power levels", # axis label
                 lab.line = 1.5, # distance between bar label and axis label
